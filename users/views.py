...
class LoginView(FormView):
    ...
    initial = {"email": "davidoh72@gmail.com"}
...
client_id = "bdae124f0ac45f39c8b0"
client_secret = "b65e58cb5615dc10175d3c6ddcb24c87e3f3b32f"
...
def kakao_login(request):
    client_id = "83f758c48fca66333b9bf28db3309c7f"
...
def kakao_callback(request):
    try:
        ...
        # Kakao doesn't allow emails to be shared through RESTful API at this point for some reason, so the code below uses profile nickname to create a user email
        # if email is None:
        #     raise KakaoException()
        if email is None:
